...
| Send a weekly digest of competitors' Google Ads to Slack | Runs every Monday, reads competitors' ads from the Google Ads Transparency Center through an Apify Actor (HTTP Request node, no community nodes), and posts ads running now, new and stopped ads per competitor to Slack. | Marketing | [Link to Template](Slack/Send%20a%20weekly%20digest%20of%20competitors%27%20Google%20Ads%20to%20Slack.json) |
