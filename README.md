...
| Send a weekly competitor Google Ads digest from Apify to Slack | Runs every Monday, reads competitors' ads from the Google Ads Transparency Center through an Apify Actor (HTTP Request node, no community nodes), and posts ads running now, new and stopped ads per competitor to Slack. | Marketing | [Link to Template](Slack/Send%20a%20weekly%20competitor%20Google%20Ads%20digest%20from%20Apify%20to%20Slack.json) |
